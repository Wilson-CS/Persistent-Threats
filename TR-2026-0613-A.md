...
| :--- | :--- | :--- |
| `202.61.160.202` | IPv4 Address | Rogue Command & Control (C2) Server (Port 8383) |
| `temu.baskwms.top` | Domain Name | Host for Stage 2 dropper (`wwn.pdf`) |
| `shaaslong.one` | Domain Name | Host for Stage 2 dropper (`zipats.vbs`) |
| `baolongwes.oss-ap-southeast-1.aliyuncs.com` | URL Path | Alibaba OSS bucket hosting malicious `ffice.zip` |
